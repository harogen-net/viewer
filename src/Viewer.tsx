...
export class Viewer {
  ...
  private viewerDocument: ViewerDocument | undefined;
  IsDocumentModified: boolean = false;
  ...
  constructor(public obj: any, startUpMode: ViewerStartUpMode) {
    ...
    //IO section
    {
      ...
      $("#bgColor").change((e) => {
        this.viewerDocument!.bgColor = $("#bgColor")?.val()?.toString() ?? this.viewerDocument!.bgColor;
      });
    }
