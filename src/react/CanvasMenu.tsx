export function CanvasMenu() {
	return (
		<>
			<div>
				<button className="undo" data-desc="undo operation">
					<i className="fas fa-arrow-circle-left"></i>
				</button>
				<button className="redo" data-desc="redo operation">
					<i className="fas fa-arrow-circle-right"></i>
				</button>
			</div>
			<div>
				<button className="zoomOut" data-desc="zoom out">
					<i className="fas fa-search-minus"></i>
				</button>
				<button className="showAll" data-desc="set canvas to default scale">
					<i className="far fa-window-maximize"></i>
				</button>
				<button className="zoomIn" data-desc="zoom in">
			...
			<div>
				<button className="slideDownload">
