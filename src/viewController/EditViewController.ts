...
export class EditViewController extends EventDispatcher {
	...
	constructor(public obj:any){
		...
		var vms:IVMUI[] = [
			...
			new VMHistoricalVariableInput($(".property .position input").eq(0), Layer, "x", PropFlags.X, {v:-25}),
			...
			new VMHistoricalVariableInput($(".property .clip input").eq(2), ImageLayer, "clipB", PropFlags.IMG_CLIP, {v:-25, min:0}),
			new VMHistoricalVariableInput($(".property .clip input").eq(3), ImageLayer, "clipL", PropFlags.IMG_CLIP, {v:-25, min:0}),
